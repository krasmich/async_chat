...
def main():
    ...
    try:
        ...
        database_load(clientsocket, database, client_name)

        module_sender = ClientSender(client_name, clientsocket, database)
        module_sender.daemon = True
        module_sender.start()
        client_logger.debug('Запущены процессы')

        module_receiver = ClientReader(client_name, clientsocket, database)
