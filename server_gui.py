...
if __name__ == '__main__':
    ...
    # test_list.appendRow([QStandardItem('test1'), QStandardItem('192.198.0.5'), QStandardItem('54879'),
    #                      QStandardItem('16:20:34')])
    # test_list.appendRow([QStandardItem('test2'), QStandardItem('192.198.0.6'), QStandardItem('54797'),
    #                      QStandardItem('16:21:34')])
